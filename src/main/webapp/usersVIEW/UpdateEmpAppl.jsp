...
<body>
    <jsp:include page="../model/header&sidebar.jsp"></jsp:include>
     <main>
		...
		<form class="form-container" method="post" action="UpdateEmpAppl" enctype='multipart/form-data'>
					<input type="hidden" name="idCard_pictureURL_1" value="${emp.idCard_pictureURL_1}">
					<input type="hidden" name="idCard_pictureURL_2" value="${emp.idCard_pictureURL_2}">	
					<input type="hidden" name="company_taxID_docURL" value="${emp.company_taxID_docURL}">				
					<label class="form-label" for="employer_application_id"> 企業申請ID: </label>
						<input
							class="form-input" type="text"
							id="employer_application_id" name="employer_application_id" value="${emp.employer_application_id}" readonly>  									
					...
					<label class="form-label" for="user_password" >公司地址:</label>
						...
						id="company_address" name="company_address1" value="${fn:substring(emp.company_address, 3, fn:length(emp.company_address))}" required> 
					...
					<label class="form-label"for="company_taxID">公司統編:</label> 
						<input class="form-input" type="text" placeholder="修改會員餘額" 
					...
					<div class="taxID-picture" style="">						
        				<img class="taxID-img" id="taxIDImagePreview" src="${pageContext.request.contextPath}/usersVIEW/userupload/${emp.company_taxID_docURL}" alt="統編證明文件影本"/>
				    </div>						
					<div>		
						<input class="file-uploader_taxID" type="file" name="taxIDImage" accept="image/*" />
					</div>
					<label class="form-label"for="user_national_id">負責人身份證字號:</label> 
						<input class="form-input" type="text" placeholder="修改負責人身份證字號" 
						id="user_national_id" name="user_national_id" value="${emp.user_national_id}" required>
					<label class="form-label"for="nationalID-img">負責人身份證正面:</label>
					<div class="national_id-picture" style="">						
        				<img class="nationalID-img" id="nationalIDPreview1" src="${pageContext.request.contextPath}/usersVIEW/userupload/${emp.idCard_pictureURL_1}" alt="負責人身分證影本"/>      
				    </div>
				    <div>		
					...
					<label class="form-label"for="nationalID-img">負責人身份證正面:</label>
					<div class="national_id-picture" style="">						
        				<img class="nationalID-img" id="nationalIDPreview2" src="${pageContext.request.contextPath}/usersVIEW/userupload/${emp.idCard_pictureURL_2}" alt="負責人身分證影本"/>      
				    </div>
				    <div>		
