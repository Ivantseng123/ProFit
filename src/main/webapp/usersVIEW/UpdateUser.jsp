				...
				<main>
					...
					<div>
						...
						<form class="form-container" method="post" action="UpdateUser?action=nopwd"
							...
							<div>
								<input class="file-uploader" type="file" name="profileImage" id="fileInput"
									accept="image/*" />
							</div>
							...
							<div class="input-radio">
								<c:choose>
									<c:when test="${user.freelancerIdentity == '個人兼職'}">
										...
										<input type="radio" id="identityChoice2" name="freelancer_identity"
											value="工作室" />
										<label for="identityChoice2">工作室</label>
										<input type="radio" id="identityChoice3" name="freelancer_identity"
											value="學生" />
							...
							<div class="input-radio">
								<c:choose>
									<c:when test="${user.freelancerProfileStatus == 0}">
										...
										<input type="radio" id="statusChoice2" name="freelancer_profile_status"
											value="1" />
							...
							<div class="popup-box-updatepwd">
								...
								<form class="form-group" style="height: 200px; margin: 0;" method="post"
									...
									<label class="form-label" for="user_password">會員密碼:</label> <input
										...
										for="ConfirmPassword">確認密碼:</label> <input id="ConfirmPassword"
										class="form-input-insert" type="password" placeholder="確認會員密碼"
