					...
					<main>
						...
						<div>
							...
							<form class="form-container" method="post" action="UpdateEmpPf"
								...
								<input type="hidden" id="company_photoURL" name="company_photoURL" value="${emp.companyPhotoURL}">
								<label class="form-label" for="employer_profile_id"> 企業資訊ID: </label>
								<input class="form-input" type="text" id="employer_profile_id"
									name="employer_profile_id" value="${emp.employerProfileId}" readonly>
								...
								<input class="form-input" type="text" placeholder="修改公司地址" id="company_address"
									name="company_address1" value="${fn:substring(emp.companyAddress, 3, fn:length(emp.companyAddress))}
" required>
								...
								<input class="form-input" type="text" placeholder="修改公司統編" id="company_taxID"
									name="company_taxID" value="${emp.companyTaxID}" required>

								<label class="form-label" for="company_numberOfemployee">公司員工數:</label>
								<select id="numberOfemployee" class="numOfemp-option" name="company_numberOfemployee"
								...
								<input class="form-input" type="text" placeholder="修改公司資本額" id="company_captital"
									name="company_captital" value="${emp.companyCaptital}">
								...
								<div class="company-picture" style="">
									<img class="company-img" id="companyImgPreview" src="${emp.companyPhotoURL}"
										alt="公司照片" />
								</div>
								<div>
									<input class="file-uploader_companyImg" id="fileInput" type="file" name="companyPhoto"
										accept="image/*" />
								</div>
								<button class="insertbtn" type="button" style="margin-top: 20px; margin-bottom: 20px"
								id="fetchButton">上傳公司照片</button>
