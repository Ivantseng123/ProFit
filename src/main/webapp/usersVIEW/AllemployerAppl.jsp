    ...
    <main>
            ...
            <table id="userTable" class="display">
                ...
                <tbody>
                	<c:forEach items="${emps}" var="emp" varStatus="s">
                    	<tr>
                        	<td>${emp.employer_application_id}</td>
                        	<td>${emp.user_id}</td>
                        	<td>${emp.user_email}</td>
                        	<td>${emp.company_name}</td>
                        	<td>${emp.company_phoneNumber}</td>
                        	<td>${emp.company_taxID}</td>
                        	<c:choose>
                        	...
                        	<td class="action-buttons">
                        		...
                        		<a style="text-decoration:none;" href="GetEmpAppl?employer_application_id=${emp.employer_application_id}">
                        		<button class="view" id="viewUserBtn">查看</button>
                        		</a>
                            	<a style="text-decoration:none;" href="GetUpdateEmpAppl?employer_application_id=${emp.employer_application_id}">
        ...
        <div id="popupOverlay" class="overlay-container" style="z-index: 1002">
        	<div class="popup-box-empAppl">
				...
				<form class="form-group" style="height:700px;margin:0; overflow: auto" method="post" action="InsertEmpAppl" enctype='multipart/form-data'>
				    ...
				    <div>		
						<input class="file-uploader_taxID" type="file" name="taxIDImage"
		...
		$(function() {
			$(document).ready(function() {
			 ...
			 $('tbody').on('click','#passEmpApplBtn',function(){
				 ...
				 const data = { 'employer_application_id':  employer_application_id,
						 		'user_id' : user_id,
						 			  'check' : check						
				 				};
